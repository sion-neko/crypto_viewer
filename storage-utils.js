...
window.getPriceHistoryCacheKey = getPriceHistoryCacheKey;
window.getCurrentPricesCacheKey = getCurrentPricesCacheKey;
window.getChartDataCacheKey = getChartDataCacheKey;
window.getCacheKeyType = getCacheKeyType;
window.CACHE_KEY_PATTERNS = CACHE_KEY_PATTERNS;
